			...
			VStack(alignment: .center) {
				...
				VStack {
					VStack(alignment: .leading, spacing: 8) {
						...
						HStack {
							Text("Meow would like to use your current location to determine where you are on the map, how far are other Meshtastic® nodes, and, optionally, feed your node with location updates.")
								.font(.callout)
					...
					VStack(alignment: .leading, spacing: 8) {
						...
						HStack {
							Text("Meow also would like to deliver you notifications in case it discovers new Meshtastic® node, or when you got a new message. You can customize which notifications you would like later in Options.")
								.font(.callout)
								.foregroundStyle(.gray)
								.padding(.leading, 32)
